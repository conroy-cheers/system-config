    ...
    define_submap = [
      ...
      }
      {
        _args = [
          ...
          (lua ''
            function()
              hl.bind("grave + Q", hl.dsp.window.close())
              hl.bind("CTRL + grave + delete", hl.dsp.exit())
              hl.bind("grave + 1", hl.dsp.exec_cmd("hyprworkspace 1"))
              hl.bind("grave + 2", hl.dsp.exec_cmd("hyprworkspace 2"))
              hl.bind("grave + 3", hl.dsp.exec_cmd("hyprworkspace 3"))
              hl.bind("grave + 4", hl.dsp.exec_cmd("hyprworkspace 4"))
              hl.bind("grave + 5", hl.dsp.exec_cmd("hyprworkspace 5"))
              hl.bind("grave + 6", hl.dsp.exec_cmd("hyprworkspace 6"))
              hl.bind("grave + 7", hl.dsp.exec_cmd("hyprworkspace 7"))
              hl.bind("grave + 8", hl.dsp.exec_cmd("hyprworkspace 8"))
              hl.bind("grave + 9", hl.dsp.exec_cmd("hyprworkspace 9"))
              hl.bind("CTRL + grave + left", hl.dsp.focus({ workspace = "r-1" }))
              hl.bind("CTRL + grave + right", hl.dsp.focus({ workspace = "r+1" }))
              hl.bind("grave + Return", hl.dsp.workspace.toggle_special(), { dont_inhibit = true })
              hl.bind("SHIFT + grave + W", hl.dsp.window.fullscreen())
            end
          '')
        ];
      }
