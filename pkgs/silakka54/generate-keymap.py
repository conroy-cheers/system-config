...
def key_report_masks(layers, layer_indices):
...
def main():
    ...
    rendered_key_report_masks = render_key_report_masks(key_report_masks(layers, layer_indices))
...
#define SILAKKA54_KEY_REPORT_BYTES {(KEY_COUNT + 7) // 8}
...
static uint8_t reported_keys[SILAKKA54_KEY_REPORT_BYTES] = {{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}};
